...
def create_dp_parser():
    ...
    parser.add_argument("-s", "--sigma", dest="sigma", type=float, default=None)
    parser.add_argument("-n", "--max-norm", dest="C", type=float, default=4.0)
    parser.add_argument("--epsilon", dest="epsilon", type=float, default=None)
    parser.add_argument("--delta", dest="delta", type=float, default=None)
    parser.add_argument("--target-deltas", type=float, default=1e-5, nargs="*")
    parser.add_argument("--target-epsilons", type=float, default=4.0, nargs="*")
